...
import '../../../new_services/signup_api_service.dart';

class EmpProfileEdit extends StatefulWidget {
  const EmpProfileEdit({super.key});

  @override
  State<EmpProfileEdit> createState() => _EmpProfileEditState();
}

class _EmpProfileEditState extends State<EmpProfileEdit> {
      ...
      child: Scaffold(
            ...
            child: Padding(
              ...
              child: Form(
               ...
               Center(child:   profilePic == null
                  ...
                  child: Container(
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          labelText: employerUserData?['name'] ),
                    ),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                          labelStyle: TextStyle(color: AppColors.black),
                          labelText: employerUserData?['gender'] ),
                    ),
                ...
                decoration: InputDecoration(
                  hintText: employerUserData?['age'].toString() ,
                  hintStyle: TextStyle(
                  ...
                  validator: (value) {
                    ...
                    if (GlobalConstant.userType == "Employer")
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                            labelStyle: TextStyle(color: AppColors.black),
                            labelText:  employerUserData?['email']),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: employerUserData?['address']?['addressLine1'],
                        labelStyle: TextStyle(color: AppColors.black),
                      ),
                    ),
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText:employerUserData?['address']?['addressLine2'],
                        labelStyle: TextStyle(color: AppColors.black),
                      ),
                    ),
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: employerUserData?['address']?['block'] ,
                        labelStyle: TextStyle(color: AppColors.black),
                      ),
                    ),
                     DropdownButton<String>(
                      value: selectedState,
                      hint: Text(employerUserData?['address']?['state'],style:TextStyle(color: AppColors.black, fontWeight: FontWeight.w400)),
                    ...
                    DropdownButton<String>(
                      value: selectedcity,
                      hint: Text(employerUserData?['address']?['city'],style: TextStyle(color: AppColors.black, fontWeight: FontWeight.w400),),
                      onChanged: (String? newValue) {
                        setState(() {
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: employerUserData?['address']?['pinCode'],
                        labelStyle: TextStyle(color: AppColors.black),
                      ),
                      keyboardType: TextInputType.number,
                    ),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText:  employerUserData?['aadharNumber'],
                        labelStyle: TextStyle(color: AppColors.black),
                      ),
                    ),
                    SizedBox(
                            ...
                            ? Column(
                              children: [
                                CircleAvatar(
                                    radius: mediaQuery.size.width * 0.11,
                                    backgroundColor: Colors.grey[300], // Placeholder background color
                                    child:Image.network(employerUserData?['aadharImage'])
                                  ),
        ...
        //               ),
              ...
              TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText:  employerUserData?['bio'],
                        labelStyle: TextStyle(color: AppColors.black),
                      ),
                      maxLines: 2,
                    ),
