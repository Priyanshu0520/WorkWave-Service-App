...
class EmpCompletedOrderService {
  final String apiUrl =
      'https://workwave-backend.vercel.app/api/v1/employer/get/getCompletedOrderByEmployerId/' +
      ...
      final completedOrders = List<Map<String, dynamic>>.from(data
          .expand((user) =>
              user['completedOrders']
                  .map((order) => order['completedOrderDetails'])
                  .toList()));
